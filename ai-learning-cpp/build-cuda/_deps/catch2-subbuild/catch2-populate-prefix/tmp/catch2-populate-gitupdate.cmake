...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v3.7.1"
  WORKING_DIRECTORY "/mnt/d/mayAi/AILearning_v0527/ai-learning-cpp/build-cuda/_deps/catch2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/d/mayAi/AILearning_v0527/ai-learning-cpp/build-cuda/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/d/mayAi/AILearning_v0527/ai-learning-cpp/build-cuda/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
